...
if __name__ == "__main__":
    ...
    parser.add_argument('-o','--output', type=str, default="./project.md",
                        help='The path of the output file')
    parser.add_argument('-us','--use_structure', action='store_true',
                        help='Use the structure of the code to generate the documentation')
    parser.add_argument('-ir','--ignore_relations', action='store_true',
                        help='Add description of the relationship between modules')
    parser.add_argument('-ig','--ignore_graphs', action='store_true',
